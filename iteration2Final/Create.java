		...
		*/
		...
		createAccount.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//calls hash-map stored in accountType class and stores email and schoolRole to it 
				...
				//saves the value in the hash-map to a file so it can be preserved between program calls 
				try {
				...
				//reads the data from the file into hash-map every time the program starts 
				try {
